    ...
    public static class DataSeeder
    {
        ...
        private static void Languages(PathfinderContext context)
        {
            context.Languages.AddRange(
                ...
                new Language() { Name = "Aboleth" },
                new Language() { Name = "Abyssal" },
                new Language() { Name = "Aklo" },
                new Language() { Name = "Aquan" },
                new Language() { Name = "Auran" },
                new Language() { Name = "Boggard" },
                new Language() { Name = "Celestial" },
                new Language() { Name = "Common" },
                new Language() { Name = "Cyclops" },
                new Language() { Name = "Dark Folk" },
                new Language() { Name = "Draconic" },
                new Language() { Name = "Drow Sign Language" },
                new Language() { Name = "Druidic" },
                new Language() { Name = "Dwarven" },
                new Language() { Name = "Dziriak" },
                new Language() { Name = "Elven" },
                new Language() { Name = "Giant" },
                new Language() { Name = "Gnoll" },
                new Language() { Name = "Gnome" },
                new Language() { Name = "Goblin" },
                new Language() { Name = "Grippli" },
                new Language() { Name = "Halfling" },
                new Language() { Name = "Ignan" },
                new Language() { Name = "Infernal" },
                new Language() { Name = "Necril" },
                new Language() { Name = "Orc" },
                new Language() { Name = "Protean" },
                new Language() { Name = "Sphinx" },
                new Language() { Name = "Sylvan" },
                new Language() { Name = "Tengu" },
                new Language() { Name = "Terran" },
                new Language() { Name = "Treant" },
                new Language() { Name = "Undercommon" },
                new Language() { Name = "Vegepygmy" }
            );
        }
        ...
        {
            context.AddRange(
                new StatKey { Name = "Dexterity" },
                new StatKey { Name = "Strength" },
                new StatKey { Name = "Constitution" },
                new StatKey { Name = "Intelligence" },
                new StatKey { Name = "Wisdom" },
                new StatKey { Name = "Charisma" },
                new StatKey { Name = "Hit Points" },
                new StatKey { Name = "Fortitude Save" },
                new StatKey { Name = "Will Save" },
                new StatKey { Name = "Reflex Save" },
                new StatKey { Name = "Damage" },
                new StatKey { Name = "Armour" },
                new StatKey { Name = "Size" },
                new StatKey { Name = "Arcane Spell Failure" },
                new StatKey { Name = "Skill Checks" },
                new StatKey { Name = "Land Speed" },
                new StatKey { Name = "Fly Speed" },
                new StatKey { Name = "Swim Speed" },
                new StatKey { Name = "Burrow Speed" },
                new StatKey { Name = "Climb Speed" },
                new StatKey { Name = "Fire Energy Resistance" },
                new StatKey { Name = "Cold Energy Resistance" },
                new StatKey { Name = "Electricity Energy Resistance" },
                new StatKey { Name = "Acid Energy Resistance" },
                new StatKey { Name = "Sonic Energy Resistance" },
                new StatKey { Name = "Experience" },
                new StatKey { Name = "Damage Reduction" },
                new StatKey { Name = "Spell Resistance" },
                new StatKey { Name = "Critical Multiplier" },
                new StatKey { Name = "Critical Range" },
                new StatKey { Name = "Armour Check Penalty" },
                new StatKey { Name = "Initiative" },
                new StatKey { Name = "Acrobatics" },
                new StatKey { Name = "Appraise" },
                new StatKey { Name = "Bluff" },
                new StatKey { Name = "Climb" },
                new StatKey { Name = "Craft" },
                new StatKey { Name = "Diplomacy" },
                new StatKey { Name = "Disable Device" },
                new StatKey { Name = "Disguise" },
                new StatKey { Name = "Escape Artist" },
                new StatKey { Name = "Fly" },
                new StatKey { Name = "Handle Animal" },
                new StatKey { Name = "Heal" },
                new StatKey { Name = "Intimidate" },
                new StatKey { Name = "Knowledge Arcana" },
                new StatKey { Name = "Knowledge Dungeoneering" },
                new StatKey { Name = "Knowledge Engineering" },
                new StatKey { Name = "Knowledge Geography" },
                new StatKey { Name = "Knowledge History" },
                new StatKey { Name = "Knowledge Local" },
                new StatKey { Name = "Knowledge Nature" },
                new StatKey { Name = "Knowledge Nobility" },
                new StatKey { Name = "Knowledge Planes" },
                new StatKey { Name = "Knowledge Religion" },
                new StatKey { Name = "Linguistics" },
                new StatKey { Name = "Perception" },
                new StatKey { Name = "Perform" },
                new StatKey { Name = "Profession" },
                new StatKey { Name = "Ride" },
                new StatKey { Name = "Sense Motive" },
                new StatKey { Name = "Sleight of Hand" },
                new StatKey { Name = "Spellcraft" },
                new StatKey { Name = "Stealth" },
                new StatKey { Name = "Survival" },
                new StatKey { Name = "Swim" },
                new StatKey { Name = "Use Magic Device" }
